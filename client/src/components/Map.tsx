...
const Map = (): JSX.Element => {
  ...
  const [trigger, setTrigger] = useState(false); // Trigger to refetch data
  ...
  return (
    <div className="flex flex-col items-center justify-start space-y-8">
      <MapDataFilter onApplyFilter={applyFilters} />

      <div className="w-[60vw] bg-gray-50">
        <div id="map" style={{ height: "60vh", zIndex: 1 }}></div>
      </div>
      <Charts censusBlock={censusBlocks} trigger={trigger} />
    </div>
  );
};
